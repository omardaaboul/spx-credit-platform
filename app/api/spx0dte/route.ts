...
const DEFAULT_TWO_DTE_SETTINGS: TwoDteSettings = {
  ...
  min_strike_distance: 20,
  max_strike_distance: 70,
  min_credit: 0.45,
  max_credit: 1.4,
  use_delta_stop: true,
  delta_stop: 0.5,
...
const DEFAULT_BWB_SETTINGS: BwbSettings = {
  ...
  min_dte: 14,
  max_dte: 30,
  iv_rank_threshold: 35,
  short_delta_min: 0.24,
  short_delta_max: 0.34,
  near_long_delta_target: 0.32,
  near_long_delta_tolerance: 0.06,
  far_long_delta_max: 0.25,
  narrow_wing_min: 5,
  narrow_wing_max: 15,
  wide_to_narrow_min_ratio: 1.6,
  min_credit_per_narrow: 0.07,
