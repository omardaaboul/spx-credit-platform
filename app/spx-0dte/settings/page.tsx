  ...
  const saveSettings = async () => {
    try {
      ...
      const twoDtePayload = {
        ...
        short_delta_min: numOr(baseTwoDte.short_delta_min, 0.1),
        short_delta_max: numOr(baseTwoDte.short_delta_max, 0.2),
        auto_select_params: boolOr(baseTwoDte.auto_select_params, true),
        min_strike_distance: numOr(baseTwoDte.min_strike_distance, 30),
        max_strike_distance: numOr(baseTwoDte.max_strike_distance, 50),
        min_credit: numOr(baseTwoDte.min_credit, 0.8),
        max_credit: numOr(baseTwoDte.max_credit, 1.0),
        use_delta_stop: boolOr(baseTwoDte.use_delta_stop, true),
        delta_stop: numOr(baseTwoDte.delta_stop, 0.4),
