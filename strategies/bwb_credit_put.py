...
class BwbSettings:
    ...
    short_delta_min: float = 0.24
    short_delta_max: float = 0.34
    near_long_delta_target: float = 0.32
    near_long_delta_tolerance: float = 0.06
    far_long_delta_max: float = 0.25
    narrow_wing_min: float = 5.0
    narrow_wing_max: float = 15.0
    wide_to_narrow_min_ratio: float = 1.6
    min_credit_per_narrow: float = 0.07
